...
class LookupCountryCodeProvider implements CountryCodeProviderInterface
{
    ...
    public function getCountryCodeByBin(string $binNumber): string
    {
        ...
        if (empty($binUrl)) {
            throw InternalServerErrorException::createFromMessage('Missing ENV variable BIN_LIST_URL!');
        }
