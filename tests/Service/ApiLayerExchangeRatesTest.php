...
class ApiLayerExchangeRatesTest extends TestCase
{
    ...
    private ExchangeRatesProviderInterface $exchangeRate;
    ...
    public function setUp(): void
    {
        ...
        $this->exchangeRate = new ApiLayerExchangeRatesProvider($this->httpClient);
    }
